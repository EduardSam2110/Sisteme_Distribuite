...
class MessageProcessorMicroservice {
    ...
    private fun receiveAndProcessMessages() {
        val receivedMessages = mutableSetOf<String>() // ca sa filtram duplicatele
        ...
        val receiveInQueueSubscription = receiveInQueueObservable
            ...
            .filter { receivedMessages.add(it) } // intr un Set elementele sunt unice
            .subscribeBy(
                onNext = {
                ...
                onComplete = {
                    ...
                    sendProcessedMessages(sortedMessages)
                },
