...
class EratosteneSieveService {
    ...
    fun union(a: Multime, b: Multime): Multime {
        return Multime(a.valori.union(b.valori))
    }

    fun intersect(a: Multime, b: Multime): Multime {
        return Multime(a.valori.intersect(b.valori))
    }
