        ...
        val receiveInQueueSubscription = receiveInQueueObservable
            ...
            .subscribeBy(
                onNext = {
                    ...
                    log("MessageProcessor", message.toString())
...
"Trimit urmatoarele mesaje:")
            Observable.fromIterable(messageQueue).subscribeBy(
                onNext = {
                    log("MessageProcessor", it.toString())
                    log("MessageProcessor", it.toString())
            ...
            log("MessageProcessor",
"Nu ma pot conecta la BiddingProcessor!")
